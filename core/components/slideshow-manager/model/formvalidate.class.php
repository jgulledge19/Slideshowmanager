...
class formValidate{
    ...
    public function checkFile($file){
        ...
        if ( !in_array($file_ext, $allow_array) || $this->_getFileType($file_ext) != $_FILES[$file]['type'] ){
            if( $file_ext == 'rtf' && $_FILES[$file]['type'] == 'application/msword' ) {
                // do nothing!
            } else{
                $this->error_array[$file] = 'Incorrect file type';
                return;
            }
        }
    ...
    */
    ...
    private function _getFileType($ex) {
