<div id="joshua19media_wrapper">
    ...
    <p><a href="{$_url.slide_add}">{$_lang.slideshow_manager.slide_add}</a></p>
    ...
    <form name="toolbar" action="" method="get" class="joshua19media" >
        ...
        <fieldset>
            <legend>{$_lang.slideshow_manager.legend_sort}</legend>
            <ul>
                <li class="autoWidth">
                    <input name="sort_type" type="radio" value="current" id="rd_current" {$_frmSort.sort_type.radio.current} class="radio" /> 
                    <label for="rd_current">{$_lang.slideshow_manager.label_sort_type_current}</label>
                </li>
                <li class="autoWidth spaceRight">
                    ...
                    <label for="rd_future">{$_lang.slideshow_manager.label_sort_type_future}</label>
                </li>
                <li class="autoWidth spaceRight">
                    <input name="sort_type" type="radio" value="tbd" id="rd_tbd" {$_frmSort.sort_type.radio.tbd} class="radio" /> 
                    <label for="rd_tbd">{$_lang.slideshow_manager.label_sort_type_tbd}</label>
                </li>
                <li class="autoWidth spaceRight">
                    <input name="sort_type" type="radio" value="archive" id="rd_archive" {$_frmSort.sort_type.radio.archive} class="radio" /> 
                    <label for="rd_archive">{$_lang.slideshow_manager.label_sort_type_archive}</label>
                </li>
                <li class="autoWidth">
                    <div class="jgbuttons">
                        <button type="submit"> {$_lang.slideshow_manager.button_sort} </button>
                    </div>
                </li>
            </ul>
        </fieldset>
