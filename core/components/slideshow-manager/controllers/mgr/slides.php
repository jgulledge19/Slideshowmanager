...
foreach ($slides as $slide_id => $slide ) {
    ...
    <li>
        ...
        <p>'.$my_lexicon['slideshow_manager']['slide_sequence'].' '.$slide->get('sequence').'<p>
...
return $modx->smarty->fetch( MODX_CORE_PATH.'components/slideshow-manager/templates/slides.tpl' ); 
