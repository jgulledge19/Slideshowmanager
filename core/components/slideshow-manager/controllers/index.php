...
$modx->regClientCSS(MODX_ASSETS_URL.'components/slideshow-manager/css/layout.css');
$modx->regClientCSS(MODX_ASSETS_URL.'components/slideshow-manager/css/form.css');

define('SLIDE_MODEL_DIR', dirname(dirname(__FILE__)).'/model/' );
require_once SLIDE_MODEL_DIR.'slideshow-manager/jgslideshow.class.php';
