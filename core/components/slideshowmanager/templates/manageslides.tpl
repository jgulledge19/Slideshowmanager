<div id="joshua19media_wrapper">
    ...
    <form name="form_add" action="?" method="post" class="joshua19media" enctype="multipart/form-data">
        <fieldset>
            <legend>{if $edit_me}{$_lang.slideshowmanager.legend_slide_edit}
                {else}
                {$_lang.slideshowmanager.legend_slide_create}
                {/if}</legend>
            <ul>
                ...
                <li class="half"><label for="txt_url">{if $_frm.url.isError}<span class="spanError"><sup>{$_frm.url.errorNumber}</sup></span>
                    {/if}{$_lang.slideshowmanager.label_url}</label> 
                ...
                <li class="clear small spaceRight"><label for="txt_sequence">{if $_frm.sequence.isError}<span class="spanError"><sup>{$_frm.sequence.errorNumber}</sup></span>
                    {/if}{$_lang.slideshowmanager.label_sequence}</label> 
            ...
            <li class="autoWidth">
                <p>{if $_frm.slide_status.isError}<span class="spanError"><sup>{$_frm.slide_status.errorNumber}</sup></span>
                        {/if}{$_lang.slideshowmanager.label_slide_status}</p>
                {* Radio buttons *}
                <ul>
                {if $edit_me}
                    {* existing slide *}
                    <li class="autoWidth spaceRight">
                        ...
                        <label for="rd_live">{$_lang.slideshowmanager.label_slide_status_live}</label>
                    </li>
                    <li class="autoWidth spaceRight">
                        <input name="slide_status" type="radio" value="archive" id="rd_archive" class="radio" {$_frm.slide_status.radio.archive} /> 
                        <label for="rd_archive">{$_lang.slideshowmanager.label_slide_status_archive}</label>
                    </li>
                    <li class="autoWidth spaceRight">
                        <input name="slide_status" type="radio" value="deleted" id="rd_deleted" class="radio" {$_frm.slide_status.radio.deleted} /> 
                        <label for="rd_deleted">{$_lang.slideshowmanager.label_slide_status_delete}</label>
                    </li>
                {else}
                    {* new slide *}
                    <li class="autoWidth spaceRight">
                        <input name="slide_status" type="radio" value="insert" id="rd_insert" class="radio" {$_frm.slide_status.radio.insert} /> 
                        <label for="rd_insert">{$_lang.slideshowmanager.label_slide_status_insert}</label>
                    </li>
                    <li class="autoWidth spaceRight">
                        <input name="slide_status" type="radio" value="replace" id="rd_replace" class="radio" {$_frm.slide_status.radio.replace} /> 
                        <label for="rd_replace">{$_lang.slideshowmanager.label_slide_status_replace}</label>
                    </li>
                {/if}
                    <li class="autoWidth">
                        <input name="slide_status" type="radio" value="tbd" id="rd_tbd" class="radio" {$_frm.slide_status.radio.tbd} /> 
                        <label for="rd_tbd">{$_lang.slideshowmanager.label_slide_status_tbd}</label>
                    </li>
                </ul>
            </li>
                ...
                <li><label for="txt_notes">
                    ...
                    {/if}{$_lang.slideshowmanager.label_notes}</label> 
                ...
                <li class="medium spaceRight"><label for="txt_html">
                    ...
                    {/if}{$_lang.slideshowmanager.label_html}</label> 
                ...
                <li><label for="txt_options">
                    ...
                    {/if}{$_lang.slideshowmanager.label_options}</label> 
                    ...
                    <div class="jgbuttons">
                        <button type="submit" class="positive" name="save_file">
                            <img src="{$_myconfig.imagesUrl}check.gif" alt="save" /> {if $edit_me}
                                {$_lang.slideshowmanager.button_edit}
                            {else}
                                {$_lang.slideshowmanager.button_add}
                            {/if} </button>
                    </div>
                </li>            
            </ul>
